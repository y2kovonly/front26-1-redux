...
const Table = () => {
  ...
  return (
    <>
      <div className="grid grid-cols-1 grid-rows-min gap-2 w-full text-sm text-left text-gray-table-auto border-collapse border-spacing-2">
        { items.map((item) => (
          <div key={item.id} className="hover:bg-slate-200 bg-white rounded-md flex gap-1 px-2">
            <div className="py-1"><input type="checkbox" className="default:ring-2 checked:bg-green" /></div>
